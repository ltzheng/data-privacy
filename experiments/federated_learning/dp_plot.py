...
C_list = np.array([0.1, 0.4, 0.7, 1.0, 1.3, 1.5])
sigma_list = np.array([0.05, 0.2, 0.5, 0.8, 1.0, 1.3, 1.5])
...
for C in C_list:
    for sigma in sigma_list:
        ...
        cmd = "python main.py --mode DP --gpu 0 --no-plot --epoch 6\
...
# plot(train_acc, 'DP_exp_train_acc')
# plot(test_acc, 'DP_exp_test_acc')
# plot(epsilon, 'DP_exp_epsilon', 5)
